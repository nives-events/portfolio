      ...
      <div className="container-page py-24">
        ...
        <Reveal delay={140}>
          ...
          <a
            ...
            download
            className="group relative mt-12 inline-flex items-center gap-3 overflow-hidden border border-primary px-8 py-4 text-sm font-medium uppercase tracking-widest text-primary transition-transform duration-100 active:scale-[0.97]"
          >
            <span
              aria-hidden="true"
              className="absolute inset-0 origin-left scale-x-0 bg-primary transition-transform duration-200 ease-out-strong group-hover:scale-x-100"
            />
